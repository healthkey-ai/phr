...
live in this service's Postgres, and sibling services verify phr-issued JWTs
(offline via /api/v1/auth/jwks/, or through /api/v1/auth/introspect/).
"""
...
# Vite build output — added to staticfiles sources when present (Docker build)
