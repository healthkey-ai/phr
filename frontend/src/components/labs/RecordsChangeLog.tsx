 ...
 */
import { FileText, PenLine, Upload as UploadIcon } from "lucide-react";

import { useLabResults, useLabUploads } from "@/features/labs/api";
import type { LabResult, LabUpload, LabUploadFile } from "@/types/labs";
...
function FileGroup({ group }: { group: FilenameGroup }) {
  return (
    <div>
...
function formatResultValue(r: LabResult): string {
  if (r.value != null) {
